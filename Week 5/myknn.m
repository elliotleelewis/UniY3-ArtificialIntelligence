classdef myknn
    methods(Static)
        ...
        % Makes set of predictions based on model passed in
        ...
        % Makes a single prediction based on model passed in
        ...
        % Helper function to calculate the distances of a value from the
        % values in the model passed into this function.
        ...
        % Helper function to generate the euclidian distance of a single
        % pair of values.
